...
const locations = [
  { 
    ...
    hint: "tech park",
    mapEmbed: `<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3234.9648956794963!2d80.04348670544218!3d12.82335794469804!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a52f70d1d93653b%3A0x7648f1677f1242c8!2sSRM%20Tech%20Park!5e0!3m2!1sen!2sin!4v1756318561215!5m2!1sen!2sin" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>`,
    clickable: true,
  },
  { 
    name: "Canteen", 
...
export function InteractiveMapCard() {
  ...
  return (
    <>
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {locations.map((loc) => (
              <div
                key={loc.name}
                className={`group relative overflow-hidden rounded-lg shadow-md ${loc.clickable ? 'cursor-pointer' : 'cursor-default'}`}
      ...
      <Dialog open={!!selectedLocation} onOpenChange={(isOpen) => !isOpen && handleModalClose()}>
