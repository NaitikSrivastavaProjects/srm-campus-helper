...
const locations = [
  { name: "Tech Park", img: "https://thedriftingfocus.wordpress.com/wp-content/uploads/2012/12/imag01031.jpg?w=1024&h=548", hint: "tech park", map: "https://i.imgur.com/gSnP3aA.png" },
...
export function InteractiveMapCard() {
  ...
  return (
    <>
      ...
      <Dialog open={!!selectedMap} onOpenChange={(open) => !open && setSelectedMap(null)}>
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            <DialogTitle>Tech Park Map</DialogTitle>
          </DialogHeader>
          {selectedMap && (
            <Image
              src={selectedMap}
